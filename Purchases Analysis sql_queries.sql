...
SELECT 
    ...
    purchase_amount,
    discount_applied,
    AVG(purchase_amount) OVER () AS average_purchase_amount
FROM customers
...
SELECT TOP 5
    ROUND(AVG(review_rating), 2) AS "Average Procuct Rating",item_purchased
FROM customers
